class MatchBoxStarter{
	...
	public static void main(String[] matchboxes){
		...
		MatchBox matchbox2=new MatchBox("lion",50,4);
		...
		MatchBox matchbox3=new MatchBox("lion",50,4,5);
		...
		MatchBox matchbox4=new MatchBox("lion",50,4,5,"medium");
		...
		MatchBox matchbox5=new MatchBox("lion",50,4,5,"medium",10);
		...
		MatchBox matchbox6=new MatchBox("lion",50,4,5,"medium",10,"Wooden");
